...
if __name__ == "__main__":
    ...
    parser.add_argument('-lr', dest="lr", default=0.002, type=float, help='Learning rate')
    ...
    parser.add_argument('-num_neg', dest="num_neg", default=48, type=int, help='Number of negative samples')
